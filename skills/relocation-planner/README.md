...
- The skill surfaces every assumption the server reports in the structured `assumed_defaults[]`
  array (`{ field, assumed_value, note }`) so you can correct any silent default.
