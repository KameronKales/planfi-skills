...
- "Build me a complete financial plan — one document covering retirement, college, estate, and insurance."
...
- "Do I qualify for the Saver's Credit on $34k income, and how much is it worth on a $2k Roth IRA?"
- "How much can I pull from my IRA penalty-free at 52 with a 72(t) SEPP — amortization vs RMD vs annuitization?"
- "Should I max my HSA and invest it instead of spending it — and how much tax-free medical reserve will I have at 65 if I bank my receipts and reimburse later?"
- "Is a fixed-indexed annuity with a 9% cap worth it vs keeping my rollover IRA invested, and how is the non-qualified gain taxed?"
- "How much Roth conversion room do I have before RMDs hit at 73, and will my RMDs trigger a Medicare IRMAA surcharge?"
- "I inherited a $500k IRA from my dad — do I owe annual RMDs, and what's the tax-smartest way to empty it over the 10-year window?"
...
- "Will converting $40k to Roth push more of my Social Security into the 85% taxable zone — what's my real marginal rate, and how much can I convert before the tax torpedo fires?"
- "Why is my marginal rate 40%+ when I'm only in the 22% bracket, and how much worse does the SS tax torpedo get for my spouse if she's widowed and files single?"
...
- "My kid's UTMA throws off $4k of dividends — what's the kiddie tax, and should I gift him $30k of appreciated stock to harvest the gain at 0%? Plus, does a UTMA hurt his financial aid vs a 529, and how much can I gift tax-free this year?"
...
```
npx skills add KameronKales/planfi-skills          # choose from all 17
npx skills add KameronKales/planfi-skills --all    # install all 17
...
| [**financial-forecast**](https://github.com/holdequity/planfi-financial-forecast) | Build a complete FIRE / financial forecast: net-worth projection, FIRE age, Monte Carlo success rate, insights, action plan, what-if scenario comparisons, childcare cost + dependent-care FSA / Child & Dependent Care Credit / Child Tax Credit offsets with a corrected second-income tradeoff, and education/estate deep-dives including federal education tax credits (American Opportunity vs Lifetime Learning Credit per student, MAGI phase-out, refundable/non-refundable split, and the $4k 529 carve-out to preserve full AOTC), a 529→Roth rollover (SECURE 2.0) + 5-year gift-tax-averaged 529 superfunding optimizer, plus estate- and inheritance-tax exposure covering the 6 inheritance-tax states (PA/NJ/KY/IA/MD/NE, taxed by beneficiary relationship class regardless of estate size) and ~12 estate-tax states (MA/NY/OR/WA + CT/DC/HI/IL/ME/MD/MN/RI/VT), and a kiddie-tax & UTMA/UGMA funding planner (IRC §1(g) tier liability on a child's unearned income, appreciated-stock gifting into the child's 0% LTCG bracket, the UTMA-vs-529 FAFSA asset-treatment penalty, and annual gift-exclusion headroom). | `npx skills add holdequity/planfi-financial-forecast` |
...
| [**tax-optimizer**](https://github.com/holdequity/planfi-tax-optimizer) | Cut taxes across accounts and years: broad tax optimization (asset location, tax-loss harvesting, charitable), a dedicated charitable-giving optimizer (analyze_charitable_giving — DAF bunching to clear the standard deduction, a QCD at 70½+ that lowers AGI/IRMAA/Social-Security taxation, and donating long-term appreciated stock/RSUs in-kind to avoid capital gains while still taking the FMV deduction), multi-year ISO/conversion timing (AMT/NIIT/IRMAA-aware), Roth conversion ladders, mega-backdoor Roth space, advanced surtaxes (NIIT/AMT/state), tax-gain harvesting (how much long-term gain you can realize at the 0% capital-gains rate before NIIT/IRMAA bites), tax-loss harvesting (analyze_tax_loss_harvesting — harvest lot-level unrealized losses to offset realized gains and up to $3,000 of ordinary income, flag wash sales, suggest replacement securities), a lot-level tax-lot optimizer (analyze_tax_lots — pick which individual purchase lots to sell, HIFO vs FIFO vs specific-ID, to minimize gain or maximize harvested loss; ST-vs-LT split per lot; the §1091 wash-sale disallowance + basis adjustment on equities; and the crypto carve-out where property losses are harvestable and can be repurchased immediately, with a proposed-future-law toggle), retirement relocation / state-tax arbitrage with full 50-state + DC progressive single/MFJ brackets (compare the lifetime after-tax cost of retiring in one state vs another), the federal Saver's Credit (50/20/10% of retirement contributions for lower/moderate income), 72(t)/SEPP substantially-equal-payment sizing for penalty-free access to retirement money before 59½, and HSA-as-retirement optimization (analyze_hsa_retirement — max-fund + invest the triple-tax-advantaged HSA, the receipt-shoebox deferred-reimbursement strategy, the 6-months-before-Medicare contribution stop, and the age-65 tax-free-medical vs taxable-non-medical pivot). | `npx skills add holdequity/planfi-tax-optimizer` |
...
| [**retirement-income**](https://github.com/holdequity/planfi-retirement-income) | Plan retirement decumulation: tax-smart withdrawal order, dynamic/variable spending strategies (Guyton-Klinger guardrails, VPW, spending smile, bucket+buffer vs a static 4% SWR), Social Security claiming age, ACA healthcare bridge before Medicare, projected RMDs with a tax-torpedo and Roth-conversion-runway readout (the low-income years before RMDs start at 73/75), Medicare IRMAA tier and surcharge-cliff lookup, Medicare enrollment-timing windows and permanent late-enrollment penalties (the 7-month IEP, the Part B 10%-per-year and Part D 1%-per-month permanent penalties in lifetime dollars, the creditable-coverage test for working past 65 with COBRA not creditable for Part B, the 8-month SEP, and the one-time 6-month Medigap guaranteed-issue window), the post-SECURE-Act inherited-IRA 10-year drawdown for non-spouse beneficiaries (required-vs-optional annual RMDs, lump-vs-even-vs-bracket-fill tax comparison, and the year-10 cliff), estate-tax exposure, guaranteed income (pension lump-sum vs lifetime monthly, SPIA/QLAC vs DIY portfolio), a dedicated defined-benefit pension election analyzer (lump-sum-vs-lifetime implied-IRR and break-even age, 50%/75%/100% joint-and-survivor vs single-life, COLA-vs-non-COLA real erosion over a 25-30 year retirement, and the actuarial early-vs-normal claiming reduction — with the real income floor folding into the forecast), deferred/accumulation annuity products (fixed-indexed FIA cap/participation crediting, RILA buffer/floor, multi-year-guaranteed MYGA, and variable annuities with a GLWB rollup rider) with non-qualified exclusion-ratio tax and 1035 exchanges, a bond/TIPS ladder income floor that guarantees the first N years of spending (sequence-of-returns protection), a mass-market safe-cash ladder for the same near-term need (FDIC-insured CD ladders — brokered vs bank, early-withdrawal penalty, callable — plus I-Bonds and Series EE savings bonds with their purchase caps and federal tax-deferral / state exemption), and long-term-care cost exposure with a self-insure vs traditional vs hybrid LTC-policy tradeoff (including the impact on a surviving spouse's plan). Ask Claude things like 'I'm 66 and just enrolled in Medicare 30 months late — what's my permanent Part B late penalty?', 'I'm 65 and still working on my employer plan, do I need to sign up for Part B or will I owe a penalty?', or 'I lose my employer coverage in March — how long is my Special Enrollment Period and when does my Medigap guaranteed-issue window close?'. | `npx skills add holdequity/planfi-retirement-income` |
| [**debt-and-cashflow**](https://github.com/holdequity/planfi-debt-and-cashflow) | Pay down debt and route surplus cash optimally: avalanche/snowball debt payoff order, balance-transfer / debt-consolidation break-even (personal loan vs 0% transfer vs status quo), mortgage prepay vs invest, refinance break-even, a next-best-dollar funding waterfall, student-loan strategy (IDR / PSLF / refinance vs aggressive payoff), emergency-fund / cash-runway sizing (months-of-runway target from job stability, dependents, and income type, plus a too-much-cash check), finance vs lease vs pay-cash car analysis (real-dollar net cost over your hold horizon, net of resale, interest, and the opportunity cost of cash), and a household cash-flow / take-home analyzer (gross-to-net paycheck after pre-tax deductions, federal/state/FICA tax, the monthly free-cash-flow budget waterfall, true gross & net savings rates vs your FIRE target, and a 50/30/20 needs/wants/savings overspend check). | `npx skills add holdequity/planfi-debt-and-cashflow` |
...
| [**self-employed-planner**](https://github.com/holdequity/planfi-self-employed-planner) | Plan self-employed / business-owner retirement: max Solo 401(k) vs SEP-IRA vs SIMPLE contribution room, owner cash-balance / defined-benefit plan sizing (actuarial annual contribution, §415(b) cap, the DB-plus-Solo-401(k) stacked deductible and backdoor-Roth interaction), the §199A QBI deduction (thresholds, W-2/UBIA cap, SSTB phaseout), the S-corp reasonable-salary tradeoff (payroll tax vs QBI vs retirement room), and estimated/quarterly tax & 90%/110% safe-harbor planning to avoid underpayment penalties. | `npx skills add holdequity/planfi-self-employed-planner` |
| [**relocation-planner**](https://github.com/holdequity/planfi-relocation-planner) | Compare retirement relocation / state-tax arbitrage by orchestrating the public planfi MCP — how much a move (e.g. CA→TX/FL) saves in state income tax (full 50-state + DC progressive single/MFJ brackets), property tax, estate tax, and cost of living — and model the transition year you actually move in: part-year-resident day-count apportionment, source-based wage/equity/gains sourcing, the resident-state credit for taxes paid to the other state, reciprocity agreements, and the 183-day/domicile statutory-residency test. Ask Claude things like 'I moved from CA to TX in July, how do I file two state returns?', 'my RSUs vested after I moved from NY to CA — which state taxes them and do I get a credit?', or 'does PA–NJ reciprocity mean I only owe my home state?'. | `npx skills add holdequity/planfi-relocation-planner` |
| [**long-term-rental-analyzer**](https://github.com/holdequity/planfi-long-term-rental-analyzer) | Long-term-rental after-tax analyzer: 27.5-yr depreciation shelter, ~25% recapture at sale, 1031 like-kind deferral, a Schedule E P&L (rent, vacancy, opex, NOI), and an IRC §469 passive-activity-loss planner (analyze_passive_losses — the $25k special allowance with its $100k–$150k MAGI phase-out, suspended-loss carryforward schedule, real-estate-professional qualification, and total tax deferred), and a §1031 like-kind exchange planner (analyze_1031_exchange — the 45-day / 180-day deadlines, cash + mortgage-relief boot recognition, gain deferred, replacement-property carryover basis, carried §1250 recapture, and the NPV of deferring vs paying the tax now). | `npx skills add holdequity/planfi-long-term-rental-analyzer` |
...
| [**ss-tax-torpedo**](https://github.com/holdequity/planfi-ss-tax-torpedo) | Model the Social Security provisional-income tax torpedo and survivor single-filer cliffs | `npx skills add holdequity/planfi-ss-tax-torpedo` |
