...
| [**retirement-income**](https://github.com/holdequity/planfi-retirement-income) | Plan retirement decumulation: tax-smart withdrawal order, Social Security claiming age, ACA healthcare bridge before Medicare, estate-tax exposure, and guaranteed income — pension lump-sum vs lifetime monthly and whether a SPIA/QLAC beats a DIY portfolio. | `npx skills add holdequity/planfi-retirement-income` |
