...
| [**retirement-income**](https://github.com/holdequity/planfi-retirement-income) | Plan retirement decumulation: tax-smart withdrawal order, Social Security claiming age, ACA healthcare bridge before Medicare, estate-tax exposure, guaranteed income (pension lump-sum vs lifetime monthly, SPIA/QLAC vs DIY portfolio), and a bond/TIPS ladder income floor that guarantees the first N years of spending (sequence-of-returns protection). | `npx skills add holdequity/planfi-retirement-income` |
